...
if __name__=="__main__":
    ...
    #parser.add_argument('--index_reachpath', type=str, default="../pathranking/redict.pkl",
    ...
    #parser.add_argument('--rel_path', type=str, default="../relation_prediction/"+SCALE+'/'+MODEL+'_results/'+TYPE+".txt",
    parser.add_argument('--rel_path', type=str, default="../relation_prediction/"+'test'+'/'+MODEL+'_results/'+TYPE+".txt",
